  ...
  _L4:
	...
	# IfZ _tmp65 Goto _L6
	  ...
	  sw $t3, -152($fp)	# spill _tmp58 from $t3 to $fp-152
	  sw $t4, -156($fp)	# spill _tmp59 from $t4 to $fp-156
	  sw $t5, -180($fp)	# spill _tmp65 from $t5 to $fp-180
	  beqz $t5, _L6	# branch if _tmp65 is zero 
  ...
  _L6:
	...
	# IfZ _tmp78 Goto _L7
	  ...
	  sw $t4, -232($fp)	# spill _tmp78 from $t4 to $fp-232
	  beqz $t4, _L7	# branch if _tmp78 is zero 
  ...
  _L9:
	...
	# Goto _L4
	  ...
	  sw $t1, -340($fp)	# spill _tmp105 from $t1 to $fp-340
	  sw $t2, -336($fp)	# spill _tmp104 from $t2 to $fp-336
	  sw $t4, -308($fp)	# spill _tmp97 from $t4 to $fp-308
	  sw $t5, -320($fp)	# spill _tmp100 from $t5 to $fp-320
	  sw $t6, -316($fp)	# spill _tmp99 from $t6 to $fp-316
	  sw $t7, -268($fp)	# spill _tmp87 from $t7 to $fp-268
	  sw $t8, -172($fp)	# spill _tmp63 from $t8 to $fp-172
  _L5:
	# EndFunc
	# (below handles reaching end of fn body with no explicit return)
	  move $sp, $fp		# pop callee frame off stack
  ...
  _L16:
	...
	# Goto _L13
	  ...
	  sw $t5, -128($fp)	# spill _tmp157 from $t5 to $fp-128
	  sw $t6, -140($fp)	# spill _tmp160 from $t6 to $fp-140
	  sw $t7, -136($fp)	# spill _tmp159 from $t7 to $fp-136
  _L14:
	# EndFunc
	# (below handles reaching end of fn body with no explicit return)
	  move $sp, $fp		# pop callee frame off stack
  ...
  _L18:
	...
	# IfZ _tmp192 Goto _L20
	  ...
	  sw $t4, -100($fp)	# spill _tmp192 from $t4 to $fp-100
	  beqz $t4, _L20	# branch if _tmp192 is zero 
  ...
  _L28:
	...
	# Goto _L28
	  ...
	  sw $t1, -116($fp)	# spill _tmp267 from $t1 to $fp-116
	  sw $t2, -120($fp)	# spill _tmp268 from $t2 to $fp-120
	  sw $t3, -124($fp)	# spill _tmp269 from $t3 to $fp-124
	  sw $t4, -96($fp)	# spill _tmp262 from $t4 to $fp-96
  _L29:
	# EndFunc
	# (below handles reaching end of fn body with no explicit return)
	  move $sp, $fp		# pop callee frame off stack
  ...
  _L38:
	...
	# Goto _L38
	  ...
	  sw $t3, -44($fp)	# spill _tmp352 from $t3 to $fp-44
	  sw $t4, -48($fp)	# spill _tmp353 from $t4 to $fp-48
  _L39:
	# EndFunc
	# (below handles reaching end of fn body with no explicit return)
	  move $sp, $fp		# pop callee frame off stack
  ...
  _L61:
	...
	# Goto _L58
	  ...
	  sw $t6, -148($fp)	# spill _tmp485 from $t6 to $fp-148
	  sw $t7, -160($fp)	# spill _tmp488 from $t7 to $fp-160
	  sw $t8, -156($fp)	# spill _tmp487 from $t8 to $fp-156
  _L59:
	# EndFunc
	# (below handles reaching end of fn body with no explicit return)
	  move $sp, $fp		# pop callee frame off stack
  ...
  _L70:
	...
	# Goto _L67
	  ...
	  sw $t6, -112($fp)	# spill _tmp560 from $t6 to $fp-112
  ...
  _L75:
	...
	# Goto _L72
	  ...
	  sw $t6, -128($fp)	# spill _tmp600 from $t6 to $fp-128
