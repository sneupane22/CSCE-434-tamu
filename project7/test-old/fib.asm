  ...
  _L0:
	...
	# f1 = _tmp5
	  move $t3, $t2		# copy value to register for f1
	# _tmp6 = 2
	  li $t4, 2		# load constant value 2 into $t4
	# i = _tmp6
	  move $t5, $t4		# copy value to register for i
  ...
  _L2:
	...
	# _tmp10 = f0 + f1
	  ...
	  add $t2, $t0, $t1	
	# f2 = _tmp10
	  move $t3, $t2		# copy value to register for f2
	# f0 = f1
	  move $t0, $t1		# copy value to register for f0
	# f1 = f2
	  move $t1, $t3		# copy value to register for f1
	# _tmp11 = 1
	...
	# _tmp12 = i + _tmp11
	  ...
	  add $t6, $t5, $t4	
	# i = _tmp12
	  move $t5, $t6		# copy value to register for i
	# Goto _L2
