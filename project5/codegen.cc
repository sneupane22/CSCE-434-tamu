...
Location *CodeGenerator::GenTempVar()
{
        ...
        result = new Location(CurrentSegment,
                              CurrentLocalOffset,
                              temp); 
        if (CurrentSegment == fpRelative)  {
                CurrentLocalOffset -= 4; 
                CurrentFunctionFrame += VarSize; 
        }
        else if (CurrentSegment == gpRelative)
...
void CodeGenerator::ResetFunctionFrame()
{
        CurrentFunctionFrame = 0;
}
