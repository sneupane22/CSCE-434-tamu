  ...
  _L1:
	...
	# IfZ _tmp35 Goto _L3
	  ...
	  sw $t7, -48($fp)	# spill _tmp34 from $t7 to $fp-48
	  sw $t8, -52($fp)	# spill _tmp35 from $t8 to $fp-52
	  beqz $t8, _L3	# branch if _tmp35 is zero 
  ...
  _L3:
	...
	# Goto _L1
	  ...
	  sw $t8, -80($fp)	# spill _tmp42 from $t8 to $fp-80
  ...
  _L4:
	...
	# _tmp65 = _tmp61 || _tmp64
	  sw $t7, -156($fp)	# spill _tmp59 from $t7 to $fp-156
	...
	# IfZ _tmp65 Goto _L6
	  ...
	  sw $t8, -160($fp)	# spill _tmp60 from $t8 to $fp-160
	  sw $t9, -180($fp)	# spill _tmp65 from $t9 to $fp-180
	  beqz $t9, _L6	# branch if _tmp65 is zero 
  ...
  _L6:
	...
	# IfZ _tmp78 Goto _L7
	  ...
	  beqz $t9, _L7	# branch if _tmp78 is zero 
  ...
  _L7:
	...
	# _tmp89 = _tmp85 || _tmp88
	  sw $t7, -256($fp)	# spill _tmp84 from $t7 to $fp-256
	...
	# IfZ _tmp89 Goto _L8
	  ...
	  beqz $t9, _L8	# branch if _tmp89 is zero 
  ...
  _L8:
	...
	# _tmp100 = _tmp99 == _tmp96
	  sw $t8, -300($fp)	# spill _tmp95 from $t8 to $fp-300
	...
	# IfZ _tmp101 Goto _L9
	  ...
	  beqz $t9, _L9	# branch if _tmp101 is zero 
  ...
  _L13:
	...
	# IfZ _tmp147 Goto _L15
	  ...
	  sw $t8, -88($fp)	# spill _tmp147 from $t8 to $fp-88
	  beqz $t8, _L15	# branch if _tmp147 is zero 
  ...
  _L15:
	...
	# IfZ _tmp161 Goto _L16
	  ...
	  sw $t7, -128($fp)	# spill _tmp157 from $t7 to $fp-128
	  sw $t8, -132($fp)	# spill _tmp158 from $t8 to $fp-132
	  sw $t9, -144($fp)	# spill _tmp161 from $t9 to $fp-144
	  beqz $t9, _L16	# branch if _tmp161 is zero 
  ...
  _L16:
	...
	# ACall _tmp168
	  ...
	  sw $t7, -172($fp)	# spill _tmp168 from $t7 to $fp-172
  ...
  _BJDeck.DealCard:
	...
	# IfZ _tmp178 Goto _L17
	  ...
	  sw $t3, -32($fp)	# spill _tmp176 from $t3 to $fp-32
	  sw $t4, -36($fp)	# spill _tmp177 from $t4 to $fp-36
	  sw $t5, -28($fp)	# spill _tmp175 from $t5 to $fp-28
  ...
  _L18:
	...
	# IfZ _tmp192 Goto _L20
	  ...
	  sw $t7, -92($fp)	# spill _tmp190 from $t7 to $fp-92
	  sw $t8, -96($fp)	# spill _tmp191 from $t8 to $fp-96
	  sw $t9, -100($fp)	# spill _tmp192 from $t9 to $fp-100
	  beqz $t9, _L20	# branch if _tmp192 is zero 
  ...
  _L20:
	...
	# _tmp200 = ACall _tmp199
	  ...
	  sw $t7, -128($fp)	# spill _tmp199 from $t7 to $fp-128
	  jalr $t7            	# jump to function
	  move $t0, $v0		# copy function return value from $v0
	# PopParams 4
	  add $sp, $sp, 4	# pop params off stack
  ...
  _L24:
	...
	# IfZ _tmp220 Goto _L26
	  ...
	  sw $t8, -52($fp)	# spill _tmp220 from $t8 to $fp-52
	  beqz $t8, _L26	# branch if _tmp220 is zero 
  ...
  _L26:
	...
	# ACall _tmp227
	  ...
	  sw $t7, -80($fp)	# spill _tmp227 from $t7 to $fp-80
	  jalr $t7            	# jump to function
	# PopParams 4
	  add $sp, $sp, 4	# pop params off stack
	# _tmp228 = 1
  ...
  _L25:
	...
	# PushParam _tmp231
	  ...
	  sw $t0, 4($sp)	# copy param value to stack
	# LCall _PrintString
	  sw $t0, -96($fp)	# spill _tmp231 from $t0 to $fp-96
	  jal _PrintString   	# jump to function
	# PopParams 4
	  add $sp, $sp, 4	# pop params off stack
	# EndFunc
  ...
  _Player.Hit:
	...
	# IfZ _tmp253 Goto _L27
	  sw $t1, -56($fp)	# spill _tmp252 from $t1 to $fp-56
	  sw $t3, -60($fp)	# spill _tmp253 from $t3 to $fp-60
	  sw $t4, -52($fp)	# spill _tmp251 from $t4 to $fp-52
  ...
  _Player.DoubleDown:
	...
	# IfZ _tmp280 Goto _L30
	  ...
	  sw $t3, -48($fp)	# spill _tmp279 from $t3 to $fp-48
	  sw $t4, -40($fp)	# spill _tmp277 from $t4 to $fp-40
  ...
  _L33:
	...
	# IfZ _tmp316 Goto _L34
	  ...
	  sw $t7, -96($fp)	# spill _tmp316 from $t7 to $fp-96
  ...
  _Player.PlaceBet:
	...
	# PushParam this
	  ...
	  sw $t1, 4($sp)	# copy param value to stack
	# ACall _tmp345
	  sw $t0, -12($fp)	# spill _tmp344 from $t0 to $fp-12
  ...
  _L38:
	...
	# IfZ _tmp354 Goto _L39
	  ...
	  sw $t8, -48($fp)	# spill _tmp353 from $t8 to $fp-48
	  sw $t9, -52($fp)	# spill _tmp354 from $t9 to $fp-52
	  beqz $t9, _L39	# branch if _tmp354 is zero 
  ...
  _Player.Resolve:
	...
	# IfZ _tmp366 Goto _L40
	  ...
	  sw $t4, -40($fp)	# spill _tmp364 from $t4 to $fp-40
	  sw $t5, -32($fp)	# spill _tmp362 from $t5 to $fp-32
  ...
  _House.SetupGame:
	...
	# PushParam _tmp436
	  ...
	  sw $t0, 4($sp)	# copy param value to stack
	# LCall _PrintString
	  sw $t0, -28($fp)	# spill _tmp436 from $t0 to $fp-28
	...
	# _tmp444 = LCall _Alloc
	  sw $t0, -56($fp)	# spill _tmp443 from $t0 to $fp-56
	  jal _Alloc         	# jump to function
	  move $t0, $v0		# copy function return value from $v0
	# PopParams 4
	  add $sp, $sp, 4	# pop params off stack
	...
	# PushParam _tmp446
	  ...
	  sw $t0, 4($sp)	# copy param value to stack
	# ACall _tmp448
	  sw $t0, -68($fp)	# spill _tmp446 from $t0 to $fp-68
	...
	# PushParam _tmp449
	  ...
	  sw $t1, 4($sp)	# copy param value to stack
	# ACall _tmp451
	  sw $t0, -84($fp)	# spill _tmp450 from $t0 to $fp-84
  ...
  _House.SetupPlayers:
	...
	# IfZ _tmp455 Goto _L57
	  sw $t0, -24($fp)	# spill _tmp454 from $t0 to $fp-24
  ...
  _L58:
	...
	# IfZ _tmp473 Goto _L60
	  ...
	  sw $t7, -96($fp)	# spill _tmp472 from $t7 to $fp-96
	  sw $t8, -100($fp)	# spill _tmp473 from $t8 to $fp-100
	  beqz $t8, _L60	# branch if _tmp473 is zero 
  ...
  _L60:
	...
	# _tmp489 = _tmp485 || _tmp488
	  sw $t7, -140($fp)	# spill _tmp483 from $t7 to $fp-140
	...
	# IfZ _tmp489 Goto _L61
	  ...
	  sw $t8, -144($fp)	# spill _tmp484 from $t8 to $fp-144
	  sw $t9, -164($fp)	# spill _tmp489 from $t9 to $fp-164
	  beqz $t9, _L61	# branch if _tmp489 is zero 
  ...
  _L61:
	...
	# PushParam _tmp482
	  subu $sp, $sp, 4	# decrement sp to make space for param
	  lw $t8, -136($fp)	# fill _tmp482 to $t8 from $fp-136
	...
	# ACall _tmp496
	  ...
	  sw $t7, -192($fp)	# spill _tmp496 from $t7 to $fp-192
	  jalr $t7            	# jump to function
	# PopParams 8
	  add $sp, $sp, 8	# pop params off stack
	# _tmp497 = 1
  ...
  _L62:
	...
	# IfZ _tmp510 Goto _L64
	  ...
	  sw $t7, -52($fp)	# spill _tmp509 from $t7 to $fp-52
	  sw $t8, -56($fp)	# spill _tmp510 from $t8 to $fp-56
	  beqz $t8, _L64	# branch if _tmp510 is zero 
  ...
  _L64:
	...
	# _tmp518 = ACall _tmp517
	  ...
	  sw $t7, -84($fp)	# spill _tmp517 from $t7 to $fp-84
	  jalr $t7            	# jump to function
	  move $t0, $v0		# copy function return value from $v0
	# PopParams 4
	  add $sp, $sp, 4	# pop params off stack
	...
	# IfZ _tmp525 Goto _L66
	  ...
	  sw $t7, -112($fp)	# spill _tmp524 from $t7 to $fp-112
	  sw $t8, -116($fp)	# spill _tmp525 from $t8 to $fp-116
	  beqz $t8, _L66	# branch if _tmp525 is zero 
  ...
  _L66:
	...
	# ACall _tmp532
	  ...
	  sw $t7, -144($fp)	# spill _tmp532 from $t7 to $fp-144
	  jalr $t7            	# jump to function
	# PopParams 4
	  add $sp, $sp, 4	# pop params off stack
  _L65:
  ...
  _L67:
	...
	# IfZ _tmp545 Goto _L69
	  ...
	  sw $t7, -48($fp)	# spill _tmp544 from $t7 to $fp-48
	  sw $t8, -52($fp)	# spill _tmp545 from $t8 to $fp-52
	  beqz $t8, _L69	# branch if _tmp545 is zero 
  ...
  _L69:
	...
	# _tmp553 = ACall _tmp552
	  ...
	  sw $t7, -80($fp)	# spill _tmp552 from $t7 to $fp-80
	  jalr $t7            	# jump to function
	  move $t0, $v0		# copy function return value from $v0
	# PopParams 4
	  add $sp, $sp, 4	# pop params off stack
	...
	# IfZ _tmp561 Goto _L71
	  ...
	  sw $t7, -108($fp)	# spill _tmp559 from $t7 to $fp-108
	  sw $t8, -112($fp)	# spill _tmp560 from $t8 to $fp-112
	  sw $t9, -116($fp)	# spill _tmp561 from $t9 to $fp-116
	  beqz $t9, _L71	# branch if _tmp561 is zero 
  ...
  _L71:
	...
	# PushParam _tmp554
	  subu $sp, $sp, 4	# decrement sp to make space for param
	  lw $t8, -88($fp)	# fill _tmp554 to $t8 from $fp-88
	  sw $t8, 4($sp)	# copy param value to stack
	# PushParam _tmp566
	  subu $sp, $sp, 4	# decrement sp to make space for param
	  sw $t5, 4($sp)	# copy param value to stack
	# ACall _tmp568
	  ...
	  sw $t7, -144($fp)	# spill _tmp568 from $t7 to $fp-144
	  jalr $t7            	# jump to function
	# PopParams 8
	  add $sp, $sp, 8	# pop params off stack
  _L70:
  ...
  _L72:
	...
	# IfZ _tmp582 Goto _L74
	  ...
	  sw $t7, -52($fp)	# spill _tmp581 from $t7 to $fp-52
	  sw $t8, -56($fp)	# spill _tmp582 from $t8 to $fp-56
	  beqz $t8, _L74	# branch if _tmp582 is zero 
  ...
  _L74:
	...
	# _tmp590 = ACall _tmp589
	  ...
	  sw $t7, -84($fp)	# spill _tmp589 from $t7 to $fp-84
	  jalr $t7            	# jump to function
	  move $t0, $v0		# copy function return value from $v0
	# PopParams 4
	  add $sp, $sp, 4	# pop params off stack
	...
	# IfZ _tmp601 Goto _L76
	  ...
	  sw $t7, -124($fp)	# spill _tmp599 from $t7 to $fp-124
	  sw $t8, -128($fp)	# spill _tmp600 from $t8 to $fp-128
	  sw $t9, -132($fp)	# spill _tmp601 from $t9 to $fp-132
	  beqz $t9, _L76	# branch if _tmp601 is zero 
  ...
  _L76:
	...
	# _tmp607 = *(_tmp606)
	  lw $t6, 0($t5) 	# load with offset
	# _tmp608 = *(_tmp607 + 32)
	  lw $t7, 32($t6) 	# load with offset
	# PushParam _tmp594
	  subu $sp, $sp, 4	# decrement sp to make space for param
	  lw $t8, -104($fp)	# fill _tmp594 to $t8 from $fp-104
	  sw $t8, 4($sp)	# copy param value to stack
	# PushParam _tmp606
	  subu $sp, $sp, 4	# decrement sp to make space for param
	  sw $t5, 4($sp)	# copy param value to stack
	# ACall _tmp608
	  ...
	  sw $t7, -160($fp)	# spill _tmp608 from $t7 to $fp-160
	  jalr $t7            	# jump to function
	# PopParams 8
	  add $sp, $sp, 8	# pop params off stack
  _L75:
  ...
  _L77:
	...
	# IfZ _tmp621 Goto _L79
	  ...
	  sw $t7, -48($fp)	# spill _tmp620 from $t7 to $fp-48
	  sw $t8, -52($fp)	# spill _tmp621 from $t8 to $fp-52
	  beqz $t8, _L79	# branch if _tmp621 is zero 
  ...
  _L79:
	...
	# ACall _tmp628
	  ...
	  sw $t7, -80($fp)	# spill _tmp628 from $t7 to $fp-80
	  jalr $t7            	# jump to function
	# PopParams 4
	  add $sp, $sp, 4	# pop params off stack
	# _tmp629 = 1
  ...
  _GetYesOrNo:
	...
	# _tmp662 = LCall _StringEqual
	  sw $t0, -20($fp)	# spill _tmp661 from $t0 to $fp-20
  ...
  main:
	...
	# _tmp668 = LCall _Alloc
	  sw $t0, -20($fp)	# spill _tmp667 from $t0 to $fp-20
	...
	# PushParam house
	  ...
	  sw $t1, 4($sp)	# copy param value to stack
	# ACall _tmp671
	  sw $t0, -32($fp)	# spill _tmp670 from $t0 to $fp-32
