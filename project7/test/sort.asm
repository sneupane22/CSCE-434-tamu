  ...
  _L1:
	...
	# IfZ _tmp21 Goto _L3
	  ...
	  beqz $t2, _L3	# branch if _tmp21 is zero 
  ...
  _L13:
	...
	# Goto _L4
	  ...
	  sw $t1, -304($fp)	# spill _tmp99 from $t1 to $fp-304
	  sw $t3, -308($fp)	# spill _tmp100 from $t3 to $fp-308
	  sw $t4, -280($fp)	# spill _tmp93 from $t4 to $fp-280
	  sw $t5, -276($fp)	# spill _tmp92 from $t5 to $fp-276
