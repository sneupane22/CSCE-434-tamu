  ...
  main:
	...
	# _tmp5 = 3
	  li $t0, 3		# load constant value 3 into $t0
	# aa = _tmp5
	  move $t1, $t0		# copy value to register for aa
	# _tmp6 = 3
	  li $t0, 3		# load constant value 3 into $t0
	# bb = _tmp6
	  move $t1, $t0		# copy value to register for bb
	# _tmp7 = 4
	  li $t0, 4		# load constant value 4 into $t0
	# cc = _tmp7
	  move $t1, $t0		# copy value to register for cc
	# _tmp8 = 4
	  li $t0, 4		# load constant value 4 into $t0
	# dd = _tmp8
	  move $t1, $t0		# copy value to register for dd
	# _tmp9 = 4
	  li $t0, 4		# load constant value 4 into $t0
	# t = _tmp9
	  move $t1, $t0		# copy value to register for t
