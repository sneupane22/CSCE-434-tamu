  ...
  _L9:
	...
	# Goto _L10
	  ...
	  sw $t2, -240($fp)	# spill _tmp76 from $t2 to $fp-240
	  sw $t3, -204($fp)	# spill _tmp67 from $t3 to $fp-204
	  sw $t4, -216($fp)	# spill _tmp70 from $t4 to $fp-216
	  sw $t5, -212($fp)	# spill _tmp69 from $t5 to $fp-212
